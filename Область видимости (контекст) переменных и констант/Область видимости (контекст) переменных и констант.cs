...
// В других методах они недоступны

// Контекст блока кода. Переменные, определенные на уровне блока кода,
// также являются локальными и доступны только в рамках данного блока.
// Вне своего блока кода они не доступны.
